...
class CreateanEventWidget extends StatefulWidget {
  const CreateanEventWidget({super.key});
...
class _CreateanEventWidgetState extends State<CreateanEventWidget>
  ...
  late CreateanEventModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CreateanEventModel());
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<ConstantsRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<ConstantsRecord> createanEventConstantsRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final createanEventConstantsRecord =
            createanEventConstantsRecordList.isNotEmpty
                ? createanEventConstantsRecordList.first
                : null;
        return Title(
            title: 'Photo Owl | Home',
                                          ...
                                          children: [
                                            ...
                                            Padding(
                                              ...
                                              child: Container(
                                                ...
                                                child: Text(
                                                  'Create an event now and share your event photos with your attendees in just a matter of time',
