...
import '/authentication/dos_and_donts/dos_and_donts_widget.dart';
...
class _RedirectionWidgetState extends State<RedirectionWidget>
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view', parameters: {'screen_name': 'Redirection'});
    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      logFirebaseEvent('REDIRECTION_Redirection_ON_INIT_STATE');
      if ((currentUserPhoto != '') &&
          (valueOrDefault(currentUserDocument?.faceId, '') != '')) {
        logFirebaseEvent('Redirection_wait__delay');
        await Future.delayed(const Duration(milliseconds: 500));
        logFirebaseEvent('Redirection_navigate_to');

        context.goNamed('HomeCopy');

        logFirebaseEvent('Redirection_backend_call');
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<UsersRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final redirectionUsersRecord = snapshot.data!;
        return Title(
            title: 'Bringer',
                                    ...
                                    if (responsiveVisibility(
                                      ...
                                      Align(
                                        ...
                                        child: Container(
                                          ...
                                          child: Builder(
                                            builder: (context) {
                                              if ((redirectionUsersRecord
                                                              .photoUrl ==
                                                          '') ||
                                                  (redirectionUsersRecord
                                                              .faceId ==
                                                          '')) {
                                                return Column(
                                                  mainAxisSize:
                                                  ...
                                                  children: [
                                                    ...
                                                    Container(
                                                      ...
                                                      child: Visibility(
                                                        visible: redirectionUsersRecord
                                                                    .photoUrl ==
                                                                '',
                                                        child: ClipRRect(
                                                          borderRadius:
                                                            ...
                                                            Padding(
                                                              ...
                                                              child:
                                                                ...
                                                                onPressed:
                                                                    () async {
                                                                  logFirebaseEvent(
                                                                      'REDIRECTION_PAGE_TAKE_SELFIE_BTN_ON_TAP');
                                                                  logFirebaseEvent(
                                                                      'Button_backend_call');
                                                            ...
                                                            Padding(
                                                              ...
                                                              child: InkWell(
                                                                ...
                                                                onTap:
                                                                    () async {
                                                                  logFirebaseEvent(
                                                                      'REDIRECTION_PAGE_Text_jyd07lhq_ON_TAP');
                                                                  logFirebaseEvent(
                                                                      'Text_backend_call');
                                                              ...
                                                              Padding(
                                                                ...
                                                                child:
                                                                  ...
                                                                  onPressed:
                                                                      () async {
                                                                    logFirebaseEvent(
                                                                        'REDIRECTION_SEE_MY_PHOTOS_BTN_ON_TAP');
                                                                    logFirebaseEvent(
                                                                        'Button_navigate_to');
