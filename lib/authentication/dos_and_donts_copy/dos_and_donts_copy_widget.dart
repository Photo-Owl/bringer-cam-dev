...
import 'dos_and_donts_copy_model.dart';
export 'dos_and_donts_copy_model.dart';

class DosAndDontsCopyWidget extends StatefulWidget {
  const DosAndDontsCopyWidget({super.key});

  @override
  State<DosAndDontsCopyWidget> createState() => _DosAndDontsCopyWidgetState();
}

class _DosAndDontsCopyWidgetState extends State<DosAndDontsCopyWidget> {
  late DosAndDontsCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DosAndDontsCopyModel());
