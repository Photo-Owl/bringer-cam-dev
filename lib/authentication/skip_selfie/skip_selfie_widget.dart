...
class SkipSelfieWidget extends StatefulWidget {
  const SkipSelfieWidget({super.key});

  @override
  State<SkipSelfieWidget> createState() => _SkipSelfieWidgetState();
}

class _SkipSelfieWidgetState extends State<SkipSelfieWidget>
    with TickerProviderStateMixin {
  late SkipSelfieModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SkipSelfieModel());

    logFirebaseEvent('screen_view', parameters: {'screen_name': 'SkipSelfie'});
                                            ...
                                            child: Padding(
                                              padding: EdgeInsetsDirectional
                                                  .fromSTEB(
                                                      20.0, 10.0, 20.0, 20.0),
                                              child: Text(
                                                'We understand it is not always easy to take a selfie depending on where you are',
                                                textAlign: TextAlign.start,
                                                style:
                                                    FlutterFlowTheme.of(context)
                                                        .bodyMedium
                                                    ...
                                                    onPressed: () async {
                                                      ...
                                                      await UserEventsRecord
                                                          ...
                                                          .set(
                                                              createUserEventsRecordData(
                                                            eventName:
                                                                'Skip selfie - Remind later - today evening',
                                                            uid: currentUserUid,
                                                            timestamp:
                                                                getCurrentTimestamp,
                                                          ));
                                                    ...
                                                    onPressed: () async {
                                                      ...
                                                      await UserEventsRecord
                                                          ...
                                                          .set(
                                                              createUserEventsRecordData(
                                                            eventName:
                                                                'Skip selfie - Remind later - tmrw eve',
                                                            uid: currentUserUid,
                                                            timestamp:
                                                                getCurrentTimestamp,
                                                          ));
