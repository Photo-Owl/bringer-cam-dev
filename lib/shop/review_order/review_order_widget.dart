...
class _ReviewOrderWidgetState extends State<ReviewOrderWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view', parameters: {'screen_name': 'ReviewOrder'});
