...
export '/shop/product/product_widget.dart' show ProductWidget;
...
export '/authentication/sign_in_copy/sign_in_copy_widget.dart'
    show SignInCopyWidget;
export '/authentication/social_sign_in_copy/social_sign_in_copy_widget.dart'
...
export '/user_pages/usageaccess/usageaccess_widget.dart' show UsageaccessWidget;
export '/user_pages/alldone/alldone_widget.dart' show AlldoneWidget;
export '/user_pages/displayover/displayover_widget.dart' show DisplayoverWidget;
export '/user_pages/connect_gallery/connect_gallery_widget.dart'
    show ConnectGalleryWidget;
export '/user_pages/settings/settings_page_widget.dart' show SettingsPageWidget;
