...
import 'newhomeui_model.dart';
export 'newhomeui_model.dart';

class NewhomeuiWidget extends StatefulWidget {
  const NewhomeuiWidget({super.key});

  @override
  State<NewhomeuiWidget> createState() => _NewhomeuiWidgetState();
}

class _NewhomeuiWidgetState extends State<NewhomeuiWidget>
    with TickerProviderStateMixin {
  late NewhomeuiModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NewhomeuiModel());

    logFirebaseEvent('screen_view', parameters: {'screen_name': 'newhomeui'});
    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      logFirebaseEvent('NEWHOMEUI_PAGE_newhomeui_ON_INIT_STATE');
      logFirebaseEvent('newhomeui_custom_action');
      _model.versionCheckResult = await actions.checkVersion();
      if (_model.versionCheckResult!) {
        logFirebaseEvent('newhomeui_wait__delay');
        await Future.delayed(const Duration(milliseconds: 0));
      } else {
        logFirebaseEvent('newhomeui_bottom_sheet');
      ...
      logFirebaseEvent('newhomeui_google_analytics_event');
      logFirebaseEvent(
        'Home screen shown',
        parameters: {
          'Uid': currentUserUid,
      ...
      logFirebaseEvent('newhomeui_backend_call');
        ...
        child: GestureDetector(
          ...
          child: Scaffold(
            ...
            floatingActionButton: FloatingActionButton(
              onPressed: () async {
                logFirebaseEvent('NEWHOMEUI_FloatingActionButton_8vw5fjmy_');
                        ...
                        itemBuilder: (context, gridViewIndex) {
                          ...
                          return Padding(
                            ...
                            child: InkWell(
                              ...
                              onTap: () async {
                                logFirebaseEvent(
                                    'NEWHOMEUI_PAGE_Stack_5dunh5jz_ON_TAP');
                        ...
                        return Builder(
                          builder: (context) {
                            ...
                            return RefreshIndicator(
                              onRefresh: () async {
                                logFirebaseEvent(
                                    'NEWHOMEUI_ListView_5bnx6avk_ON_PULL_TO_R');
                                if (valueOrDefault(
                                                                  ...
                                                                  children: [
                                                                    InkWell(
                                                                      ...
                                                                      onTap:
                                                                          () async {
                                                                        logFirebaseEvent(
                                                                            'NEWHOMEUI_PAGE_Row_ltdlyw8k_ON_TAP');
                                                                        logFirebaseEvent(
                                                                            'Row_navigate_to');
                                                                        ...
                                                                        builder:
                                                                          ...
                                                                          return Wrap(
                                                                            ...
                                                                            clipBehavior:
                                                                                Clip.none,
                                                                            children:
                                                                                List.generate(wrapUploadsRecordList.length, (wrapIndex) {
                                                                              ...
                                                                              return Container(
                                                                                ...
                                                                                child: Padding(
                                                                                  ...
                                                                                  child: InkWell(
                                                                                    ...
                                                                                    highlightColor: Colors.transparent,
                                                                                    onTap: () async {
                                                                                      logFirebaseEvent('NEWHOMEUI_PAGE_Image_gw2e463i_ON_TAP');
                                                                            ...
                                                                            children: [
                                                                              Container(
                                                                                ...
                                                                                child: InkWell(
                                                                                  ...
                                                                                  highlightColor: Colors.transparent,
                                                                                  onTap: () async {
                                                                                    logFirebaseEvent('NEWHOMEUI_PAGE_Image_3is8w109_ON_TAP');
                                                                                    logFirebaseEvent('Image_backend_call');
                                                                              ...
                                                                              if (wrapIndex == 5)
                                                                                InkWell(
                                                                                  ...
                                                                                  highlightColor: Colors.transparent,
                                                                                  onTap: () async {
                                                                                    logFirebaseEvent('NEWHOMEUI_PAGE_Container_6vgazvrt_ON_TAP');
