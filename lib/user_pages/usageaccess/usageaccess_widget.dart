...
import 'usageaccess_model.dart';

export 'usageaccess_model.dart';

class UsageaccessWidget extends StatefulWidget {
  const UsageaccessWidget({super.key});

  @override
  State<UsageaccessWidget> createState() => _UsageaccessWidgetState();
}

class _UsageaccessWidgetState extends State<UsageaccessWidget> {
  late UsageaccessModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UsageaccessModel());

    logFirebaseEvent('screen_view', parameters: {'screen_name': 'usageaccess'});
