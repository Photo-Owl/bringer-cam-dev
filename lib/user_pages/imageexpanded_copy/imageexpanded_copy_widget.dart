                    ...
                    child: GestureDetector(
                      ...
                      child: Builder(
                        builder: (BuildContext context) {
                          final imagesItem = images[_currentIndex];
                                              ...
                                              if (!imagesItem.isLocal &&
                                                ...
                                                return InkWell(
                                                  ...
                                                  highlightColor:
                                                      Colors.transparent,
                                                  onDoubleTap: () async {
                                                    logFirebaseEvent('like_notification',parameters: {
                                                      'uid': currentUserUid,
                                                        ...
                                                        Expanded(
                                                          child: InkWell(
                                                            ...
                                                            highlightColor: Colors
                                                                .transparent,
                                                            onTap: () async {
                                                              logFirebaseEvent('seen_by',parameters: {
                                                                'uid': currentUserUid,
                                                                'photoid': valueOrDefault<String>(
                                                                  containerUploadsRecord?.key,
                                                                  '',
                                                      ...
                                                      Expanded(
                                                        child: InkWell(
                                                          ...
                                                          highlightColor:
                                                              Colors.transparent,
                                                          onTap: () async {
                                                            logFirebaseEvent('like',parameters: {
                                                            'uid': currentUserUid,
                                                            'photoid': valueOrDefault<String>(
                                                              containerUploadsRecord?.key,
                                                              '',
                                                        ...
                                                        child: Builder(
                                                          builder: (context) =>
                                                            ...
                                                            highlightColor: Colors
                                                                .transparent,
                                                            onTap: () async {
                                                              logFirebaseEvent('share',parameters: {
                                                              'uid': currentUserUid,
                                                              'photoid': valueOrDefault<String>(
                                                                containerUploadsRecord?.key,
                                                                '',
                                                        ...
                                                        child: Container(
                                                          ...
                                                          child: InkWell(
                                                            ...
                                                            highlightColor: Colors
                                                                .transparent,
                                                            onTap: () async {
                                                              logFirebaseEvent('download',parameters: {
                                                              'uid': currentUserUid,
                                                              'photoid': valueOrDefault<String>(
                                                                containerUploadsRecord?.key,
                                                                '',
                                                      ...
                                                      Expanded(
                                                        child: InkWell(
                                                          ...
                                                          highlightColor:
                                                              Colors.transparent,
                                                          onTap: () async {
                                                            logFirebaseEvent('more',parameters: {
                                                            'uid': currentUserUid,
                                                            'photoid': valueOrDefault<String>(
                                                              containerUploadsRecord?.key,
                                                              '',
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        imageitem: widget
                                                                            ...
                                                                            widget
                                                                                .index!],
                                                                        uploadid: containerUploadsRecord!
                                                                            .reference
                                                                            .id,
                                                                        uploadkey:
                                                                            containerUploadsRecord
