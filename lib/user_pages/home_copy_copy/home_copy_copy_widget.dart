        ...
        child: GestureDetector(
          ...
          child: Scaffold(
            ...
            floatingActionButton: FloatingActionButton(
              onPressed: () async {
                logFirebaseEvent('HOME_COPY_COPY_FloatingActionButton_e7ka');
                        ...
                        return Builder(
                          builder: (context) {
                            ...
                            return RefreshIndicator(
                              onRefresh: () async {
                                logFirebaseEvent(
                                    'HOME_COPY_COPY_ListView_x2wgshr1_ON_PULL');
                                if (valueOrDefault(
                                              ...
                                              return Column(
                                                ...
                                                children: [
                                                  InkWell(
                                                    ...
                                                    onTap: () async {
                                                      logFirebaseEvent(
                                                          'HOME_COPY_COPY_PAGE_Row_fz92h5ek_ON_TAP');
                                                      logFirebaseEvent(
                                                          'Row_navigate_to');
                                                                  ...
                                                                  Container(
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      onTap:
                                                                          () async {
                                                                        logFirebaseEvent(
                                                                            'HOME_COPY_COPY_Image_7n7br0zn_ON_TAP');
                                                                        logFirebaseEvent(
                                                                            'Image_backend_call');
                                                                  ...
                                                                  if (wrapIndex ==
                                                                    ...
                                                                    InkWell(
                                                                      ...
                                                                      onTap:
                                                                          () async {
                                                                        logFirebaseEvent(
                                                                            'HOME_COPY_COPY_Container_k9wuhos2_ON_TAP');
                                                                        logFirebaseEvent(
